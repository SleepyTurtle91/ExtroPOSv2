...
sealed class Screen(val route: String, val title: String, val icon: ImageVector) {
    ...
    object SalesHistory : Screen("sales_history", "Sales History", Icons.AutoMirrored.Filled.ReceiptLong)
    object Kds : Screen("kds", "KDS", Icons.Default.Kitchen)
    ...
    object SupplierManagement : Screen("supplier_management", "Suppliers", Icons.Default.Business)
    object PurchaseOrders : Screen("purchase_orders", "Purchase Orders", Icons.Default.RequestQuote)
    ...
    object AiAuditorSettings : Screen("ai_auditor_settings", "AI Silent Auditor", Icons.Default.SmartToy)
    object Diagnostics : Screen("diagnostics", "System Diagnostics", Icons.Default.HealthAndSafety)
